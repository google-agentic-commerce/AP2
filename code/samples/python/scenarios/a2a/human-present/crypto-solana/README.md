...
export GOOGLE_API_KEY="..."                 # required (or GOOGLE_GENAI_USE_VERTEXAI=true)
export SOLANA_RPC_URL="https://..."         # optional; defaults to Solana devnet
# Optional: if your Solana-aware AP2 facilitator requires an API key, export it, e.g.
# export ALGOVOI_API_KEY="..."
...
- A Solana-aware AP2 facilitator (AlgoVoi is one example) verifies Solana
