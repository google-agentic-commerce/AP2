...
class CartContents(BaseModel):
    ...
    payment_request: PaymentRequest = Field(
        ...,
        description=(
            'The W3C PaymentRequest object to initiate payment. This'
            ' contains the items being purchased, prices, and the set of'
            ' payment methods accepted by the merchant for this cart.'
        ),
    )
...
class PaymentMandateContents(BaseModel):
    ...
    payment_response: PaymentResponse = Field(
        ...,
        description=(
            'The payment response containing details of the payment'
...
class PaymentMandate(BaseModel):
    ...
    fulfill the order, separately the protocol provides additional
    visibility into the agentic transaction to the payments ecosystem.
    For this purpose, the PaymentMandate
