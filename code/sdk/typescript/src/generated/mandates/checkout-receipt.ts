...
export const CheckoutReceiptSchema = z
      ...
      const schemas = [
        z.object({
          ...
          order_id: z
            .string()
            .describe(
              'A reference to the order for the checkout. Present if and only if status is Success.',
            ),
        }),
        z.object({
...
export type CheckoutReceipt = z.infer<typeof CheckoutReceiptSchema>;
