...
async def _request_payment_credential(
    ...
    if payment_method == 'x402':
        ...
        payment_credential = payment_mandate.payment_mandate_contents.payment_response.details.get(
            'value'
        )
    else:
        message_builder = (
...
def _create_payment_receipt(
    ...
    if payment_method == 'x402':
        ...
        method_name_for_receipt = payment_mandate.payment_mandate_contents.payment_response.method_name
...
def _get_credentials_provider_client(
    ...
    if payment_method == 'x402':
        ...
        token_object = payment_mandate.payment_mandate_contents.payment_response.details.get(
            'token'
        )
